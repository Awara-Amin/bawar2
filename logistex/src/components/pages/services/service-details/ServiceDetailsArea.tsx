              ...
              <div className="col-70 order-0 order-lg-2">
                ...
                <div className="services__details-content">
                  ...
                  <p style={{ textAlign: "justify" }}>
                    ...
                    freight is typically arranged through a shipping company or
                    freight forwarder, which handles the logistics of the
                    shipment, including the booking of cargo space,
                    transportation, customs clearance, and delivery. Shipping
                    freight refers to the transportation of large quantities of
                    goods or cargo by sea, air, or land. Freight can be shipped
                    in various types of containers such as boxes, crates,
                    barrels, or pallets. The transportation of goods by freight
