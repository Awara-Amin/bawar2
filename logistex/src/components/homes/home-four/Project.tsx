        ...
        <div className="row justify-content-center">
          <div className="col-xl-5 col-lg-6">
            <div className="section__title text-center mb-50">
              <span className="sub-title">Build Your Feature With Us</span>
              {/* <h2 className="title">We Are Proud to Excellence Deliver Success</h2> */}
              {/* <h2 className="title">
                Anywhere in the world, we can help you obtain the essential
                certificates you and your business need to launch your dream
                career in your desired market.
              </h2> */}
              <h2>
                {" "}
                Obtain The Essential Certificates Your Business Need, Anywhere
                In The World.
              </h2>
            </div>
          </div>
