...
const hero_data: DataType[] = [
  {
    ...
    img: "/assets/img/slider/h4_slider_bg01_awara.jpg",
  ...
  },
  {
    ...
    desc: (
      <>
        IsoCert has served customers across Iraq over the past 15 years,
        providing a wide range of services tailored to their needs.
      </>
    ),
  },
]
